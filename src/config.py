...
class TelegramConfig(BaseModel):
    ...
    connect_timeout: float = Field(30.0, ge=1.0, le=600.0)
    read_timeout: float = Field(60.0, ge=1.0, le=600.0)
    write_timeout: float = Field(60.0, ge=1.0, le=600.0)
    pool_timeout: float = Field(10.0, ge=1.0, le=600.0)
